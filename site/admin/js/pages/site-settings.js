...
const SiteSettingsPage = {
    template: `
        <div class="page-container">
            ...
            <div class="card-box" v-loading="loading">
                ...
                <el-form ref="formRef" :model="form" label-width="140px" style="max-width: 720px;">
                    ...
                    <el-form-item label="备案号链接">
                        ...
                        <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">填写后备案号将显示为可点击的链接</div>
                    </el-form-item>
            ...
            <div class="card-box" v-loading="loading">
                <h3>其他联系方式</h3>
                <div style="font-size:13px;color:var(--text-muted);margin-bottom:16px;">可自定义名称和链接，每行一个，格式：名称 | 链接</div>
                <el-form ref="formRef" :model="form" label-width="140px" style="max-width: 720px;">
                    <el-form-item label="联系方式">
                        <el-input v-model="form.custom_contacts" type="textarea" rows="4"
                            placeholder="Bilibili | https://space.bilibili.com/xxx&#10;微博 | https://weibo.com/xxx&#10;QQ频道 | https://pd.qq.com/xxx" />
                        <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">每行填写一条，名称和链接用竖线 | 分隔</div>
                    </el-form-item>
                </el-form>
            </div>
            ...
            <div class="card-box" v-loading="loading">
                ...
                <el-form ref="formRef" :model="form" label-width="140px" style="max-width: 720px;">
                    ...
                    <el-form-item label="页脚 HTML">
                        <el-input v-model="form.footer_custom_html" type="textarea" rows="5" placeholder="自定义页脚 HTML 代码，会添加到页脚底部" />
                        <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">支持任意 HTML，如额外的链接、图标、脚本等</div>
                    </el-form-item>
                </el-form>
            </div>
